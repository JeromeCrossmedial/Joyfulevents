...
function photoframe_customize_pagesections( $wp_customize ) {
	...
	$wp_customize->add_panel( 'homepage_sections', array(
		'priority'       => 70,
		'theme_supports' => '',
		'title'          => __( 'Homepage secties', 'photoframe' ),
		'description'    => __( 'Instellingen voor secties. Indien je geen afbeelding ingestelt hebt wordt de sectie niet weergegeven', 'photoframe' ),
	) );
	
	// Add section 1.
	$wp_customize->add_section( 'homepage_section_1' , array(
		'title'      => __( 'Sectie 1','photoframe' ),
	...
	$wp_customize->add_control( new WP_Customize_Image_Control(
		$wp_customize, 'section1_background_image', array(
			  'label'      => __( 'Voeg hier je afbeelding toe voor deze sectie', 'photoframe' ),
