	...
	function ilovewp_helper_display_hero_header() {
		...
		<div id="site-hero-image">
			<div class="site-hero-slideshow-wrapper">
  			...
  			<a class="scroll-arrow" href="#sectioncontainer1"><span></span>Scroll</a>
		</div><!-- #site-hero-image -->
		<?php
			endwhile;
		} // if is_singular()
		elseif ( is_home() ) {
			...
			if ( $header_images && count( $header_images ) > 0 ) {
				...
				echo '</ul><!-- .site-hero-slideshow-list --><a class="scroll-arrow" href="#sectioncontainer1"><span></span>Scroll</a></div><!-- .site-hero-slideshow-wrapper --></div><!-- #site-hero-image -->';
			}
		}
